...
#Some genes in the dataset should now contain annotations from several databases, such as enzyme comission and COG (Clusters of Orthologous Groups) identifiers.
...
#We will now how two tab deliminated files that have gene calls followed by the E.C. number or COGID
