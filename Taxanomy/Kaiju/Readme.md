...
do
	...
	echo "#SBATCH -o /share/tearlab/Maga/Jill/CDRF_MetaGenome/Kaiju_2018/Error_Out_Files/${NEW[$i]}.Kaiju.out" >> ${NEW[$i]}.Kaiju.sh
	echo "#SBATCH -e /share/tearlab/Maga/Jill/CDRF_MetaGenome/Kaiju_2018/Error_Out_Files/${NEW[$i]}.Kaiju.err" >> ${NEW[$i]}.Kaiju.sh
